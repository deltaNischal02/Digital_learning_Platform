...
const TrainingCoursesQuiz = () => {
  ...
  useEffect(() => {
    if (topics["training-courses"]) {
      const uniqueCategories = [
        "All",
        ...new Set(topics["training-courses"].map((topic) => topic.category))
      ];
      setCategories(uniqueCategories);
    }
  }, []);

  const filteredTopics = topics["training-courses"]?.filter(
    (topic) =>
          ...
          {selectedTopic && (
            <div>
              <p>
                ...
                {topics["training-courses"]?.find((topic) => topic.id === selectedTopic)?.title}
              </p>
              <SelectWrapper>
                <Select
                  value={difficulty}
...
export default TrainingCoursesQuiz;
