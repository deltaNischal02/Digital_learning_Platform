const quizzes = [
    {
      id: 'history',  // Change ID to match the URL parameter
      title: 'History',
      questions: [
        {
          id: 1,
      ...
      {
        id: 'geography',  // Change ID to match the URL parameter
        title: 'Geography',
        difficulty: 'Medium',
        questions: [
          {
      ...
      },
      {
        ...
        questions: [
          {
            id: 1,
            questionText: 'test What is the principal objective of Rescue and Fire Fighting Services (RFFS)?',
            difficulty: 'Easy',
            options: [
              { id: 1, text: 'To maintain airport security' },
              { id: 2, text: 'To save lives in the event of an aircraft accident or incident' },
          ...
          {
            id: 1,
            questionText: ' test How long should RFFS be provided after the last aircraft departs?',
            difficulty: 'Easy',
            options: [
        ...
        {
          id: 'arffs-chapter-two-easy',
          title: 'Airport RFFS Manual - Chapter Two Quiz',
          difficulty: 'Easy',
          questions: [
            {
              id: 1,
              questionText: 'What is the definition of an aerodrome?',
              difficulty: "Easy",
              options: [
                { id: 1, text: 'A defined area on land or water associated with buildings and aircraft operations' },
                { id: 2, text: 'An area designated for parking aircraft only' },
                { id: 3, text: 'A location for storing aircraft fuel' },
                { id: 4, text: 'A road used for airport vehicles' },
              ],
              correctOptionId: 1,
              explanation: 'An aerodrome refers to an area defined for the take-off, landing, and surface movement of aircraft.',
              hint: 'It’s related to aircraft operations.',
            },
            {
              id: 2,
              questionText: 'What does the term "Acts of Unlawful Interference" include?',
              difficulty: "Easy",
              options: [
                { id: 1, text: 'Aircraft maintenance issues' },
                { id: 2, text: 'Unlawful seizure of aircraft or hostage-taking' },
                { id: 3, text: 'Flight delays due to weather' },
                { id: 4, text: 'Passenger misbehavior' },
              ],
              correctOptionId: 2,
              explanation: 'Acts of unlawful interference include criminal activities like unlawful seizure of aircraft and hostage-taking.',
              hint: 'It’s related to security breaches in aviation.',
            },
            {
              id: 3,
              questionText: 'What is the role of RFFS when an aircraft is in flight?',
              difficulty: "Easy",
              options: [
                { id: 1, text: 'Monitor for mechanical issues' },
                { id: 2, text: 'Prepare for rescue and fire-fighting response' },
                { id: 3, text: 'Inspect the runway' },
                { id: 4, text: 'Communicate with passengers' },
              ],
              correctOptionId: 2,
              explanation: 'RFFS is responsible for preparing rescue and fire-fighting services while an aircraft is in flight, in case of emergencies.',
              hint: 'Think about safety responses during flight.',
            },
            {
              id: 4,
              questionText: 'What is the main purpose of rescue and fire-fighting services at airports?',
              difficulty: "Easy",
              options: [
                { id: 1, text: 'To repair damaged aircraft' },
                { id: 2, text: 'To assist in aircraft emergencies, particularly involving fire' },
                { id: 3, text: 'To guide aircraft during takeoff and landing' },
                { id: 4, text: 'To manage airport security' },
              ],
              correctOptionId: 2,
              explanation: 'The primary role of RFFS is to assist in aircraft emergencies and perform rescue and fire-fighting operations.',
              hint: 'Focus on emergency situations.',
            },
            {
              id: 5,
              questionText: 'How is an "Aircraft in Flight" defined?',
              difficulty: "Easy",
              options: [
                { id: 1, text: 'When it reaches cruising altitude' },
                { id: 2, text: 'When its doors are closed after embarkation until they are opened after landing' },
                { id: 3, text: 'When it is on the runway' },
                { id: 4, text: 'Once its engines start' },
              ],
              correctOptionId: 2,
              explanation: 'An aircraft is in flight from the moment its doors are closed after embarkation until they are opened after landing.',
              hint: 'Consider the full process of a flight.',
            },
            {
              id: 6,
              questionText: 'Which of the following is a key component of "Acts of Unlawful Interference"?',
              difficulty: "Easy",
              options: [
                { id: 1, text: 'Weather changes' },
                { id: 2, text: 'Unlawful seizure of an aircraft' },
                { id: 3, text: 'Aircraft engine failure' },
                { id: 4, text: 'Emergency landings' },
              ],
              correctOptionId: 2,
              explanation: 'Unlawful seizure of aircraft is considered an act of unlawful interference in aviation security.',
              hint: 'Think about criminal acts involving aircraft.',
            },
            {
              id: 7,
              questionText: 'What is the function of the "Command Post" during an emergency?',
              difficulty: "Easy",
              options: [
                { id: 1, text: 'To control air traffic' },
                { id: 2, text: 'To coordinate response efforts in an emergency' },
                { id: 3, text: 'To provide food for rescue workers' },
                { id: 4, text: 'To store fire-fighting equipment' },
              ],
              correctOptionId: 2,
              explanation: 'The Command Post coordinates all response efforts during an airport emergency.',
              hint: 'It’s about leadership in an emergency.',
            },
            {
              id: 8,
              questionText: 'What is considered a "Local Standby" in the context of airport rescue operations?',
              difficulty: "Easy",
              options: [
                { id: 1, text: 'An aircraft known or suspected to have minor trouble but can land safely' },
                { id: 2, text: 'A fire on the runway' },
                { id: 3, text: 'An aircraft malfunction in flight' },
                { id: 4, text: 'A routine landing without issues' },
              ],
              correctOptionId: 1,
              explanation: 'A Local Standby is when an aircraft has minor trouble but is expected to land safely.',
              hint: 'It’s not a full emergency, but a minor issue.',
            },
            {
              id: 9,
              questionText: 'What is the purpose of the "Grid Map" in airport operations?',
              difficulty: "Easy",
              options: [
                { id: 1, text: 'To map emergency routes within the airport' },
                { id: 2, text: 'To show the topography, access roads, and water supply locations near the airport' },
                { id: 3, text: 'To track aircraft flight paths' },
                { id: 4, text: 'To locate fire hydrants' },
              ],
              correctOptionId: 2,
              explanation: 'The Grid Map shows the layout of the airport and its surroundings, including access roads and water supply locations.',
              hint: 'It helps with navigation during an emergency.',
            },
            {
              id: 10,
              questionText: 'What is the main role of an "Aircraft Operator" according to Chapter Two?',
              difficulty: "Easy",
              options: [
                { id: 1, text: 'To control air traffic' },
                { id: 2, text: 'To manage ground operations of aircraft' },
                { id: 3, text: 'To engage in commercial air transport operations' },
                { id: 4, text: 'To repair and maintain aircraft' },
              ],
              correctOptionId: 3,
              explanation: 'An aircraft operator is an entity engaged in commercial air transport operations.',
              hint: 'Think about who operates flights.',
            },
            {
              id: 11,
              questionText: 'What is the primary consideration for rescue operations during an aircraft fire?',
              difficulty: "Easy",
              options: [
                { id: 1, text: 'Saving the aircraft' },
                { id: 2, text: 'Extinguishing the fire quickly' },
                { id: 3, text: 'Saving lives by maintaining fuselage integrity' },
                { id: 4, text: 'Evacuating ground staff' },
              ],
              correctOptionId: 3,
              explanation: 'The primary goal during an aircraft fire is to save lives by protecting the fuselage and maintaining conditions for occupants.',
              hint: 'Focus on passenger safety.',
            },
            {
              id: 12,
              questionText: 'What defines a "Full Emergency" in aviation?',
              difficulty: "Easy",
              options: [
                { id: 1, text: 'An aircraft with minor technical issues' },
                { id: 2, text: 'An aircraft suspected to be in serious trouble and possibly in danger of an accident' },
                { id: 3, text: 'A scheduled flight with no passengers' },
                { id: 4, text: 'An airport security threat' },
              ],
              correctOptionId: 2,
              explanation: 'A Full Emergency is declared when an aircraft is suspected to be in serious trouble and at risk of an accident.',
              hint: 'It’s more serious than a Local Standby.',
            },
            // Continue for a total of 30 questions...
          ],
        },
      ];
